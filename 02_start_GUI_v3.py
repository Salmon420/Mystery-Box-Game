...
class Start:
    def __init__(self, parent):
        ...
        self.mystery_instructions = Label(self.start_frame,
                                        ...
                                        text="Please enter a dollar amount "
                                             ...
                                             "below. Then choose the 'Add Functions"
    ...
    def check_funds(self):
        ...
        # Set errors background colours ( and asssume that there are no
        # errors at the start...
        error_back = "#ffafaf"
        has_errors = "no"
        ...
        if has_errors == "yes":
            ...
            # set starting balance to amount eneterd by user
...
class Game:
    ...
    def __init__(self, partner,  stakes, balance):
        print("Stakes", stakes)
